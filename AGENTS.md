...
Two independently versioned artifacts live here: the addon (`addon.xml`, currently 0.24.0) and the Kodi repository addon that delivers it (`repository.rivulet/addon.xml`, currently 1.0.2).
