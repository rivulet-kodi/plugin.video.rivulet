...
# computed locally from the downloaded v0.16.0 assets on 2026-09-23 and
...
#
# The two Android rows arrived with v0.12.1 (re-verified for v0.16.0) and are what make an
...
# satisfied by a binary with no APK to bundle it in. Since v0.16.0 the same
