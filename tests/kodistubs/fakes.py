...
_DEFAULT_LOCALIZED = {
    ...
    30208: '%d CACHED',
    30212: '%d%% WATCHED',
 '%d source hidden by filters',
 '%d sources hidden by filters',
 '%d new episode ready to watch',
 '%d new episodes ready to watch',
 '%s needs configuration. Open %s in a browser, configure it, then paste the resulting manifest URL',
}
